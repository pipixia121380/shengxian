...
public class FrmMain extends JFrame implements ActionListener {
    ...
    private JMenu menu_plan=new JMenu("商品");
    private JMenu menu_class=new JMenu("具体分类");
    private JMenu menu_step=new JMenu("订单管理");
    private JMenu menu_menu=new JMenu("菜谱");
    private JMenu menu_coupon=new JMenu("优惠券");
    private JMenu menu_static=new JMenu("地址管理");
    private JMenu menu_more=new JMenu("更多");
    
    private JMenuItem  menuItem_AddPlan=new JMenuItem("主页特价");
    private JMenuItem  menuItem_DeletePlan=new JMenuItem("删除计划");
    private JMenuItem  menuItem_goto=new JMenuItem("跳转");
    ...
    private JMenuItem  menuItem_menu1=new JMenuItem("早餐");
    private JMenuItem  menuItem_menu2=new JMenuItem("午餐");
    private JMenuItem  menuItem_menu3=new JMenuItem("晚餐");
    private JMenuItem  menuItem_personalManage=new JMenuItem("个人管理");
	...
	public FrmMain(){
	    ...
	    JLabel label=new JLabel("您好!用户："+BeanUser.currentLoginUser.getUser_id());
	    statusBar.add(label);
...
//			dlg.setVisible(true);
			...
			FrmModifyPwd dlg=new FrmModifyPwd(this,"个人管理",true);
			dlg.setVisible(true);
		}
